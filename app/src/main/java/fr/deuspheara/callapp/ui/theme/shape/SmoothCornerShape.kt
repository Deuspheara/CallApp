package fr.deuspheara.callapp.ui.theme.shape
 ...
 * _CallApp_
 *
 * fr.deuspheara.callapp.ui.theme.shape.AbsoluteSmoothCornerShape
 *
 * ### Information
...
data class SmoothCornerShape(
    ...
    private val smoothnessAsPercentTL: Int = 100,
    private val cornerRadiusTR: Dp = 0.dp,
    private val smoothnessAsPercentTR: Int = 100,
    private val cornerRadiusBR: Dp = 0.dp,
    private val smoothnessAsPercentBR: Int = 100,
    private val cornerRadiusBL: Dp = 0.dp,
    private val smoothnessAsPercentBL: Int = 100
) : CornerBasedShape(
...
/**
 * Creates SmoothCornerShape with the same corner radius and smoothness applied for
 * all four corners.
 *
 ...
 */
fun SmoothCornerShape(cornerRadius: Dp, smoothnessAsPercent: Int) =
    SmoothCornerShape(
